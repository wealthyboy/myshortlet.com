...
<div class="row">
    <div class="col-md-12">
        <div class="text-right">
            <a href="{{ route('admin.agents.create') }}" rel="tooltip" title="Add  New" class="btn btn-primary btn-simple btn-xs">
                        ...
                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="{{ route('admin.agents.edit',['agent'=>$user->id]) }}" rel="tooltip" title="Edit" class="btn btn-primary btn-simple btn-xs">
