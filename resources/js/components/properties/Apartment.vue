        ...
        <div class="col-md-12 small aprts position-relative p-0" itemscope itemtype="https://schema.org/ImageGallery">
            <div class="owl-carousel owl-theme">
                <div class="item rounded-top" :key="image.id" v-for="image in room.images" itemprop="photo" itemscope
                    ...
                    <img :alt="room.name" @click.prevent="showRoom(room)"
                        :title="'book ' + room.name + '  Avenue Montaigne'" :src="image.image"
                        class="img cursor-pointer img-fluid" itemprop="contentUrl" />
                ...
                <div v-if="room.google_drive_video_link" class="item">
                    <iframe title="watch apartment video avenue montaigne" class="rounded" style="width: 100%;" height="235"
                        :src="room.google_drive_video_link" itemprop="video" itemscope
                        itemtype="https://schema.org/VideoObject"></iframe>
                </div>
            </div>
        </div>
