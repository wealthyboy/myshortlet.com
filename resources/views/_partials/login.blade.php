<form method="POST" class="login_form pl-4 pr-4" action="/login">
    ...
    <p class="form-group ">
        <button type="submit" id="login_form_button" data-loading="Loading" class=" ml-1 btn bold btn--primary btn-round btn-lg btn-block" name="login" value="Log in">Log In</button>
    </p>

    <div class="mt-4 pt-4 text-center border-top">
        <p class="form-group col-12 bold">
            Dont have an account yet? <a class=" bold" href="/register">Create One</a></p>
        </p>
    </div>
</form>